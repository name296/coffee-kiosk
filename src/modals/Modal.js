...
import { Button, Highlight, H } from "../components";
...
export const BaseModal = memo(({ isOpen, type, onCancel, onConfirm, cancelLabel, cancelIcon, confirmIcon, confirmLabel, customContent, customTts, icon: customIcon, title: customTitle, countdown }) => {
    ...
    return (
        <div className="main" ref={containerRef} data-tts-text={finalTts ? (finalTts + TTS.replay) : ''} tabIndex={-1}>
...
export const Modal = () => {
    ...
    return (
        <div className={`modal ${isAnyModalOpen ? 'active' : ''}`} aria-hidden="true">
