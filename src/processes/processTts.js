...
export const processTts = {
    [PROCESS_NAME.START]: `안녕하십니다, 장애인, 비장애인 모두 사용 가능한 무인주문기입니다, 시각 장애인을 위한 음성 안내와 키패드를 제공합니다, 키패드는 손을 아래로 뻗으면 닿는 조작부 영역에 있으며, 돌출된 점자 및 테두리로 자세한 위치를 파악할 수 있습니다, 키패드 사용은 이어폰 잭에 이어폰을 꽂거나, 상하좌우 버튼 또는 동그라미 버튼을 눌러 시작할 수 있습니다, 안내, 시작 단계, 음식을 포장할지 먹고갈지 선택합니다.${TTS.replay}`,
    ...
    [PROCESS_NAME.RECEIPT_PRINT]: `영수증을 출력하고 있습니다.`,
    [PROCESS_NAME.FINISH]: `이용해 주셔서 감사합니다, 안녕히 가십시오.`,
};
